...
const AnimatedRocket: VFC<AnimatedRocketProps> = (props) => {
  return (
    <SvgIcon {...props}>
      <path
        className='transition delay-200 ease-out group-hover:-translate-y-full group-hover:ease-in group-hover:delay-[0s]'
      ...
      />
      <path
        className='transition ease-in origin-center -translate-x-full translate-y-full  group-hover:translate-x-0  group-hover:translate-y-0 group-hover:ease-out group-hover:delay-200'
